...
local api = loadstring(game:HttpGet("https://raw.githubusercontent.com/iamz4ri/script/main/api.lua"))()
...
local function loadRemoteEvent(name)
    ...
    if Event ~= nil then
        ...
        Player:Kick("A critical error occoured, please contact Zeri#0960 with this message: \nERR_MAIN_REMOTE_EVENT_DOES_NOT_EXIST")
    end
end
