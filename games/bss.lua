...
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/iamz4ri/script/main/library.lua"))()
getgenv().api = loadstring(game:HttpGet("https://raw.githubusercontent.com/iamz4ri/script/main/api.lua"))()
local bssapi = loadstring(game:HttpGet("https://raw.githubusercontent.com/iamz4ri/script/main/bssapi.lua"))()
...
local Config = { WindowName = "BKI v"..temptable.version.." Remastered", Color = Color3.fromRGB(164, 84, 255), Keybind = Enum.KeyCode.Semicolon}
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/iamz4ri/script/main/functions/premium/loadperks.lua"))()
...
--end temp patch
    ...
    warn("Error loading BKI Premium")
end
...
serverhopkill:CreateButton("Vicious Bee Serverhopper [⚠️][📜]",function() loadstring(game:HttpGet("https://raw.githubusercontent.com/iamz4ri/script/main/functions/viciousbeeserverhop.lua"))() end):AddToolTip("Serverhops for rouge vicious bees")
